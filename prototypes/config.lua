return {
  ...
  colors = {
    ...
    gray =    { player_color = { r = 0.502, g = 0.502, b = 0.502, a = 0.5 }, chat_color = { r = 0.502, g = 0.502, b = 0.502 } },
    slate =   { player_color = { r = 0.184, g = 0.31 , b = 0.31 , a = 0.5 }, chat_color = { r = 0.184, g = 0.31 , b = 0.31  } },
    olive =   { player_color = { r = 0.502, g = 0.502, b = 0    , a = 0.5 }, chat_color = { r = 0.502, g = 0.502, b = 0     } },
    magenta = { player_color = { r = 1    , g = 0    , b = 1    , a = 0.5 }, chat_color = { r = 1    , g = 0    , b = 1     } },
    navy =    { player_color = { r = 0    , g = 0    , b = 0.502, a = 0.5 }, chat_color = { r = 0    , g = 0    , b = 0.502 } },
    maroon =  { player_color = { r = 0.502, g = 0    , b = 0    , a = 0.5 }, chat_color = { r = 0.502, g = 0    , b = 0     } },
    aqua =    { player_color = { r = 0.498, g = 1    , b = 0.831, a = 0.5 }, chat_color = { r = 0.498, g = 1    , b = 0.831 } },
    teal =    { player_color = { r = 0    , g = 0.502, b = 0.502, a = 0.5 }, chat_color = { r = 0    , g = 0.502, b = 0.502 } },
    violet =  { player_color = { r = 0.541, g = 0.169, b = 0.886, a = 0.5 }, chat_color = { r = 0.541, g = 0.169, b = 0.886 } },
    emerald = { player_color = { r = 0.314, g = 0.784, b = 0.471, a = 0.5 }, chat_color = { r = 0.314, g = 0.784, b = 0.471 } },
    tangerine={ player_color = { r = 0.824, g = 0.412, b = 0.118, a = 0.5 }, chat_color = { r = 0.824, g = 0.412, b = 0.118 } },
    plum =    { player_color = { r = 0.867, g = 0.627, b = 0.867, a = 0.5 }, chat_color = { r = 0.867, g = 0.627, b = 0.867 } },
  },
